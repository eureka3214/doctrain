...
PAGE_WIDTH = int(st.beta_get_window_width() / 2)
...
def main():
    ...
    # Page number input
    page_num = st.number_input("Enter a page number", value=1, min_value=1, max_value=get_num_pages(uploaded_file), step=1)
