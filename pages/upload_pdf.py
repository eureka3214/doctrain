...
if pdf_file is not None:
    ...
    with col1:
        ...
        result_rects = st_sparrow_labeling(fill_color="rgba(0, 151, 255, 0.3)",stroke_width=2, stroke_color="rgba(0, 50, 255, 0.7)",background_image=val, drawing_mode="transform", display_toolbar=True, update_streamlit=True, canvas_width=PAGE_WIDTH, doc_height=PAGE_HEIGHT, doc_width=PAGE_WIDTH, image_rescale=True, key="doc_annotation" )
